...
Below, we see a heat map of the feature importance for this problem. It is a bit suprising how there is just one single pixel in the center that is vastly important, while many pixels (on the periphery) are not that important. 
\begin{center}
